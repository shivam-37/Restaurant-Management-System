...
const VerifyOtpModal = ({ isOpen, onClose, onVerify, onResendOtp, email, phone, method, isLoading }) => {
                        ...
                        >
                            ...
                            <div className="text-center mb-6">
                                ...
                                <p className="text-xs text-gray-700 dark:text-gray-400 max-w-xs mx-auto">
                                    ...
                                    <br />
                                    <span className="font-bold text-rose-500 tracking-wider mt-1 inline-block">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="pt-1 flex flex-col items-center justify-center gap-2">
                                    {timeLeft > 0 ? (
                                        <div className="flex items-center gap-2 text-xs text-gray-700 dark:text-gray-400 bg-rose-500/5 px-4 py-2 rounded-xl border border-rose-500/10">
