...
const Customers = () => {
    ...
    return (
        <div className="space-y-8">
            <div className="flex justify-between items-center bg-amber-500/5 p-6 rounded-3xl border border-amber-500/10">
                <div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="px-4 py-2 bg-amber-600 text-white rounded-xl text-lg font-black shadow-lg shadow-amber-600/20">
                        {customers.length}
                    </span>
                </div>
            </div>
            ...
            <div className="grid gap-6">
                {customers.map((customer) => (
                    <motion.div
                        ...
                        className="theme-card border border-black/5 rounded-[2rem] p-8 hover:border-amber-500/30 transition-all group shadow-sm hover:shadow-2xl"
                    >
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
                            <div className="flex items-center gap-6">
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-600 to-purple-600 flex items-center justify-center text-white font-black text-2xl shadow-xl shadow-amber-500/20">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-12 flex-1 md:justify-end w-full md:w-auto">
                                <div className="text-center md:text-left">
                                    ...
                                    <div className="flex items-center justify-center md:justify-start font-black text-lg">
                                        <ShoppingBagIcon className="w-5 h-5 mr-3 text-amber-500" />
