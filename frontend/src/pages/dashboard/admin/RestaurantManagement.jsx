            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-orange-500/5 p-8 rounded-[2rem] border border-orange-500/10">
                <div className="relative flex-1 max-w-lg">
                    ...
                    <input
                        ...
                        className="w-full theme-card-item border border-black/5 rounded-2xl py-4 pl-12 pr-6 text-sm font-bold placeholder:opacity-40 focus:outline-none focus:ring-4 focus:ring-orange-500/10 transition-all"
                    />
                </div>
                <div className="flex items-center gap-4">
                    <button className="flex items-center gap-3 px-6 py-4 theme-card-item rounded-2xl border border-black/5 hover:border-orange-500/50 transition-all font-black text-[10px] uppercase tracking-widest">
                        <AdjustmentsHorizontalIcon className="w-4 h-4" />
                        Filter
                    </button>
                    <div className="h-10 w-px bg-black/5 mx-2" />
                    <p className="text-[10px] font-black uppercase tracking-widest opacity-40">
                        Total Restaurants: <span className="opacity-100 text-orange-600 dark:text-orange-400">{filteredRestaurants.length}</span>
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredRestaurants.map((restaurant, idx) => (
                    <motion.div
                        ...
                        whileHover={{ y: -8 }}
                        className="group theme-card border border-black/5 rounded-[2.5rem] overflow-hidden hover:border-orange-500 transition-all duration-500 shadow-sm hover:shadow-2xl"
                    >
                        {/* Interactive Status Bar */}
                        <div className="h-2 bg-gradient-to-r from-orange-600 via-purple-600 to-pink-500 group-hover:h-3 transition-all duration-500"></div>
                        ...
                        <div className="p-8">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 bg-orange-600 dark:bg-orange-600 text-white p-5 rounded-[1.5rem] font-black text-xs uppercase tracking-widest transition-all transform group-active:scale-95 shadow-xl shadow-orange-600/30 hover:bg-orange-700 hover:-translate-y-1"
                            >
                                Manage Restaurant
